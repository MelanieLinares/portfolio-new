          ...
          <div className="ph3 center">
            ...
            <span className="f2 b lh-title mb2">{entry.getIn(["data", "image_list_heading", "heading"])}</span>
              {(entry.getIn(["data", "image_list"]) || []).map((product, i) => <div className="ph2-ns w-50-ns" key={i}>
                ...
                <p>
                  {product.get("text")}
                  <a href={product.get("linkurl")}>{product.get("linktext")}</a>
                  {product.get("text3")}
                  if (linkurl2) {
          ...
          <div className="ph3 center">
            ...
            <div className="flex-l mhn2-l">
              <div className="w-40-l ph2-l">
                <span className="f3 b lh-title mb2">{entry.getIn(["data", "about", "heading"])}</span>
            ...
            <div className="tc">
              <a href="{{.buttonLink}}" className="btn raise">Readb more</a>
            </div>
