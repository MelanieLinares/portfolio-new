...
## Overview
- **<span aria-hidden="true">🥇</span> awards:** nominated for "Go That Extra Mile", "Mission Impossible", and "The Houdini" awards by manager and peers
- **<span aria-hidden="true">🥈</span> accomplishments:** volunteered to pioneer Level Access' new methodology, led auditing documentation team, promoted from senior accessibility analyst to accessibility consultant, achieved IAAP CPACC and CPWA certifications
- **<span aria-hidden="true">🥉</span> technical skills:** improved experience with writing ACR/VPATs, took on design reviews utilizing the new markup process, learned about the new additions to WCAG 2.2
- **<span aria-hidden="true">♾️</span> other:** got my ears pierced, visited Chicago for the first time, relaxed at a spa resort in the mountains, and had to say goodbye to the best dog
